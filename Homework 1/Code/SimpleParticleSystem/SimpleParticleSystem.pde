...
void update(float dt){
  ...
  if (leftPressed && upPressed) {
    obstacleVel = new Vec2(-obstacleSpeed, -obstacleSpeed);
    obstacleVel = obstacleVel.times(1.0/sqrt(2));           //using cos 45 and sin 45 to get the horizontal and vertical component
  }
